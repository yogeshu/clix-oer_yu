...
basePath = basePath.substr(0, basePath.indexOf("OxE/"));
 //function to add External plugins
 (function() {
   CKEDITOR.plugins.addExternal('addImage',basePath+'ckPlugins/addImage/','plugin.js');
   CKEDITOR.plugins.addExternal('closebtn',basePath+'ckPlugins/closebtn/','plugin.js');
   CKEDITOR.plugins.addExternal('addAudio',basePath+'ckPlugins/addAudio/','plugin.js');
   CKEDITOR.plugins.addExternal('addVideo',basePath+'ckPlugins/addVideo/','plugin.js');
   CKEDITOR.plugins.addExternal('addJhapp',basePath+'ckPlugins/addJhapp/','plugin.js');
   CKEDITOR.plugins.addExternal('mathjax',basePath+'plugins/mathjax/','plugin.js');
   CKEDITOR.plugins.addExternal('font',basePath+'plugins/font/','plugin.js');
   CKEDITOR.plugins.addExternal('find',basePath+'plugins/find/','plugin.js');
   CKEDITOR.plugins.addExternal('smiley',basePath+'plugins/smiley/','plugin.js');
